...
The code to build the models for the CNN-LSTM is in `src/build-model.py` and can be run with Python 3. You must run `setup.sh` before running the model as it requires the libraries to create the training data to be compiled.
